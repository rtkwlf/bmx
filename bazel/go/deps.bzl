...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:8zYzK8wI06G2+Bg2hwTUwzIYCCo6/Wd7lfS0G+GwqXU=",
        version = "v1.40.54",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Z04ewVs7JhXaYkmDhBERPi41gnltfQpMWDnTnQbaCqk=",
    ...
    go_repository(
        ...
        sum = "h1:pGleJoyD1yA5HfvuaksHxD0404gsEkNDerKsQ0N0y1s=",
        version = "v0.0.0-20211001092434-39dca1131b70",
    )
    go_repository(
